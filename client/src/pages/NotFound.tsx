  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4">
      <div className="neo-empty max-w-sm p-8 text-center">
        ...
        <Link to="/app" className="inline-flex min-h-11 items-center rounded-md border-2 border-border bg-primary px-4 py-2 text-sm font-extrabold text-foreground shadow-neoSm">
          Go to Dashboard
        </Link>
      </div>
    </div>
